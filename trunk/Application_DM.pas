  ...
  begin
    ...
    begin
     ...
     //   Dest.IE := '';
      ...
      Total.ICMSTot.vNF   := Arredonda(dmCadastros2.NFe_Faturamentos2TOTAL_NF.value,2);//Arredonda(dmCadastros2.NFe_Faturamentos2TOTAL_NF.value - dmCadastros2.NFe_Faturamentos2DESC_ACRESC.value,2);
