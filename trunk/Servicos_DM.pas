...
FUNCTION TDmServicos.HORAS_TRABALHADAS(DATA_INI,DATA_FIM,     HORA_INI,HORA_FIM,     INTER_INI,INTER_FIM,   TRAB_INI,TRAB_FIM : STRING ) :REAL;
var
  H1,H2 : real;
begin
...
FUNCTION TDmServicos.HORAS_CORRIDA(DATA_INI,DATA_FIM,  HORA_INI,HORA_FIM,     INTER_INI,INTER_FIM,   TRAB_INI,TRAB_FIM : STRING ) :Real;
var
...
function TDmServicos.DifDateUtil(dataini, datafin: string): integer;
