  ...
  object Empresas: TIBDataSet
    ...
    InsertSQL.Strings = (
      'insert into SIS_EMPRESAS'
        ...
        '   CTR_IRPJ, CTR_ISS, CTR_PIS, CUSTO_VARIAVEL, CX_COMP_SLD_ANT, ' +
        'CX_IMP_VND_AGRUPADA, '
      
        '   CX_PAGAR_CAIXA, CX_RECEBER_CAIXA, CX_TRANSP_SLD_ANT, DB_VERSA' +
        'O, DESC_BX_PARCIAL, '
      
        '   DESCONTO_MAXIMO, DESCONTOS, DESP_BANCARIA, DIG_CARTAO_VENDA, ' +
        'DIG_CHEQUE_VENDA, '
      
        '   DIG_DESC_VENDA, DIG_ITENS_NF, DIG_SENHA_VENDEDOR, DIG_UNIDADE' +
        '_VENDA, '
      
        '   DIGITA_COTACOES, DIGITA_NUM_NOTA, DIGITA_VENDEDOR_PDV, DIRETO' +
        'RIO_TEF, '
      
        '   DT_CX_MOVTO_ANTERIOR, DT_ULT_VENDA, DUPLICATA, ECF_ULTNUMERO,' +
        ' EDITA_NUM_NF, '
      
        '   ELIMINA_ZERO_PRD_SEM_GRADE, EMAIL, EMAIL_CONTROLE, EMAIL_PADR' +
        'AO, EMBUTIR_JUROS_IMPRESSOES, '
      
        '   END_NUMERO, ENDERECO, EST_ET_PROD_GRD1, EST_ET_PROD_GRD2, EST' +
        '_ET_PROD_GRD3, '
      
        '   EST_ET_PROD_GRD3_DESCTO, EST_ET_PROD_GRD3_PARC, EST_ET_PROD_G' +
        'RD4, EST_MIN_CONTA_EMAIL_ENVIO, '
        ...
        '   OFC_ENVIO_EMAIL_AUTOMATICO, OFC_EXIBE_COPIAS, OFC_EXIBE_DADOS' +
        '_COMPLEMENTARES, '
      
        '   OFC_EXIBE_MOVIMENTOS_OS, OFC_EXIBE_MOVTO_AVULSO, OFC_EXIBE_NO' +
        'TIFICACAO, '
      
        '   OFC_EXIBE_VISITA_PREVENTIVA, OFC_EXIBE_VISUALIZACAO, OFC_GERA' +
        '_FAT_AUTOMATICO, '
      
        '   OFC_LT_PRODUTO_COPIAS, PDV_ACRESCENTA_ZEROS, PDV_DIGITA_QUANT' +
        'IDADE, '
      
        '   PDV_ECF, PDV_ELIMINA_ZEROS, PDV_F4_ALTERACLIENTE, PDV_FORMA_P' +
        'AGTO, PDV_IMP_CONVENIO, '
      
        '   PDV_IMP_VINC_VALOR, PDV_LOCALCOBRANCA, PDV_MAIORVALORUNIT, PD' +
        'V_MSG1, '
      
        '   PDV_MSG2, PDV_MSG3, PDV_MSG4, PDV_MSG5, PDV_NATUREZA, PDV_PAR' +
        'CELA_VENDA, '
      
        '   PDV_PROPRIEDADE, PDV_QTDE_COD_BARRAS, PDV_REPETE_PRODUTOS, PD' +
        'V_SENHA, '
      
        '   PDV_TIPODOCTO, PDV_UNITARIO_ZERADO, PG_COM_TERC, PIS, PROPAGA' +
        'NDA, PST_MOSTRA_ENTRADAS, '
      
        '   PST_SENHA_CAIXA, REGIME_TRIBUTARIO, SELAGRUPADOR, SELECIONA_I' +
        'MPRESSORA, '
      
        '   SENHA, SENHA_EMPRESA_EXTERNA, SINCRONIZAR_BOL_DPL, SIS_MENSAG' +
        'EM_INTERNA, '
      
        '   SMTP, TAXA_ACRESC_PDV, TIPO_CAB_FATURA, TIPO_CONSULTA_PROD, T' +
        'IPO_CONTAGEM, '
      
        '   TIPO_CUSTO, TIPO_EMPRESA, TIPO_ORCAMENTO, TIPO_TAXA, TRANSF_V' +
        'LRS_CAIXA, '
      
        '   TROCO_MAXIMO, TX_JUROS_APOS, TX_JUROS_ATE, UF, ULTIMO_TURNO, ' +
        'UTILIZA_DOCTOS_INT_ENTR, '
      
        '   VALIDA_ABERTURA_CX, VALIDA_DOCUMENTOS, VENDEDOR, VER_VENDAS_E' +
        'NVIADAS)'
      'values'
        ...
        '   :CTR_BASE_ISS_NAC, :CTR_COFINS, :CTR_CSLL, :CTR_INSS, :CTR_IR' +
        'PJ, :CTR_ISS, '
      
        '   :CTR_PIS, :CUSTO_VARIAVEL, :CX_COMP_SLD_ANT, :CX_IMP_VND_AGRU' +
        'PADA, :CX_PAGAR_CAIXA, '
        ...
        '   :OFC_ENVIO_EMAIL_AUTOMATICO, :OFC_EXIBE_COPIAS, :OFC_EXIBE_DA' +
        'DOS_COMPLEMENTARES, '
      
        '   :OFC_EXIBE_MOVIMENTOS_OS, :OFC_EXIBE_MOVTO_AVULSO, :OFC_EXIBE' +
        '_NOTIFICACAO, '
      
        '   :OFC_EXIBE_VISITA_PREVENTIVA, :OFC_EXIBE_VISUALIZACAO, :OFC_G' +
        'ERA_FAT_AUTOMATICO, '
      
        '   :OFC_LT_PRODUTO_COPIAS, :PDV_ACRESCENTA_ZEROS, :PDV_DIGITA_QU' +
        'ANTIDADE, '
      
        '   :PDV_ECF, :PDV_ELIMINA_ZEROS, :PDV_F4_ALTERACLIENTE, :PDV_FOR' +
        'MA_PAGTO, '
      
        '   :PDV_IMP_CONVENIO, :PDV_IMP_VINC_VALOR, :PDV_LOCALCOBRANCA, :' +
        'PDV_MAIORVALORUNIT, '
      
        '   :PDV_MSG1, :PDV_MSG2, :PDV_MSG3, :PDV_MSG4, :PDV_MSG5, :PDV_N' +
        'ATUREZA, '
      
        '   :PDV_PARCELA_VENDA, :PDV_PROPRIEDADE, :PDV_QTDE_COD_BARRAS, :' +
        'PDV_REPETE_PRODUTOS, '
      
        '   :PDV_SENHA, :PDV_TIPODOCTO, :PDV_UNITARIO_ZERADO, :PG_COM_TER' +
        'C, :PIS, '
      
        '   :PROPAGANDA, :PST_MOSTRA_ENTRADAS, :PST_SENHA_CAIXA, :REGIME_' +
        'TRIBUTARIO, '
      
        '   :SELAGRUPADOR, :SELECIONA_IMPRESSORA, :SENHA, :SENHA_EMPRESA_' +
        'EXTERNA, '
