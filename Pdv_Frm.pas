          ...
          THEN BEGIN
               ...
               then begin
                    ...
                    THEN BEGIN
                         ...
                         Daruma_DUAL_ImprimirTextoFormatado ( NOME, 1, 0, 0, 0, 0, 0);

                         SLEEP ( 10 );

                         Daruma_DUAL_ImprimirTextoFormatado ( 'COMPROVANTE DE COMPRA', 0, 0, 0, 0, 0, 0);

                         SLEEP ( 10 );

                         Daruma_DUAL_ImprimirTextoFormatado ( NOMECLIENTE, 0, 0, 0, 0, 0, 0);

                         SLEEP ( 10 );

                         Daruma_DUAL_ImprimirTextoFormatado ( DOCUMENTOSCLIENTE, 0, 0, 0, 0, 0, 0);

                         SLEEP ( 10 );

                         Daruma_DUAL_ImprimirTextoFormatado ( 'DOCUMENTO         = ' + DOCUMENTO, 0, 0, 0, 0, 0, 0);

                         SLEEP ( 10 );

                         IF ( LENGTH (DOCUMENTO) > 55 )
                         Then Begin
                              Daruma_DUAL_ImprimirTextoFormatado ( 'HISTORICO        = ' + COPY ( DOCUMENTO,0,45), 0, 0, 0, 0, 0, 0);

                              SLEEP ( 10 );

                              Daruma_DUAL_ImprimirTextoFormatado ( '                  = ' + COPY ( DOCUMENTO,46,150), 0, 0, 0, 0, 0, 0);
                         ...
                         Daruma_DUAL_ImprimirTextoFormatado ( 'R$ ' + VALORCHEQUE, 0, 0, 0, 0, 0, 0);
                         ...
                         Daruma_DUAL_ImprimirTextoFormatado ( VALORCHEQUE, 0, 0, 0, 0, 0, 0);
                         ...
                         Daruma_DUAL_ImprimirTextoFormatado ( dmapp.CIDADE + ' ' + dmapp.UF + ', ' + dia + ' De ' + mes + ' De ' + ano, 0, 0, 0, 0, 0, 0);
                         ...
                         Daruma_DUAL_ImprimirTextoFormatado ( '______________________________________', 0, 0, 0, 0, 0, 0);

                         SLEEP ( 10 );

                         Daruma_DUAL_ImprimirTextoFormatado ( 'VISTO DO CLIENTE', 0, 0, 0, 0, 0, 0);
                         ...
                         Daruma_DUAL_ImprimirTextoFormatado ( Replicate('-', 40), 0, 0, 0, 0, 0, 0);
